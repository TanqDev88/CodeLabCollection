...
// piloto.cantidadDe Hacer capturas de este ejemplo de una propiedad privada

piloto.HablarOficial();

var azafaata1 = new Tcp();
azafaata1.Nombre = "Clota";
hunkers.Abordar(azafaata1);
